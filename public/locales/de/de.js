...
export default {
  ...
  /*Button*/
  button: "Einen Termin vereinbaren",

  /*Footer*/
  schedules: "Öffnungszeiten",
  schedulesP:
  ...
  importantMessage:
    "Wenn Sie die deutsche Sprache beherrschen, eröffnen sich Ihnen sehr interessante berufliche Möglichkeiten, denn international tätige Unternehmen sind besonders an Mitarbeitern interessiert, die mit dieser Sprache umgehen können.  Wussten Sie übrigens, dass Deutsch die zweithäufigste Sprache in den Bereichen Wissenschaft, Forschung und Entwicklung ist? Die Internationale Organisation der Frankophonie (OIF) schätzt, dass unsere Sprache bis zum Jahr 2050 die meistgesprochene Sprache der Welt sein könnte, dank der wachsenden Demografie wo 59 % der täglichen Französischsprecher leben.",

  /*About*/
  whoAmI: "Über mich",
  whoAmIP:
    "Mein Managementstudium und meine lange Karriere als staatlich geprüfte Übersetzerin und Dolmetscherin (Französisch/Deutsch) haben mich dazu bewogen, mich auf das Unterrichten von Französisch und Wirtschaftsdeutsch zu konzentrieren. Da ich von den zahlreichen Vorteilen, dem Komfort und der Effizienz von Fernlehrgängen überzeugt bin, übe ich diese Tätigkeit seit mehr als 10 Jahren online aus.  Als zertifizierte Lehrerin habe ich sehr viele internationale Schüler unterrichtet, was mir ermöglicht hat, eine große Erfahrung in diesem Bereich zu erwerben.",
  formation: "Ausbildung",
  formationList: {
    li1: "Cambridge English Certificate C1",
    li2: "Zertifizierte DAEFLE- Lehrerin – Französich als Fremdsprache.",
    li3: "Ausbildung als Proofreader und Rewriter – Centre d’Ecriture et de Communication (C.E.C), Paris.",
    li4: "Staatliche Prüfung als Übersetzerin und Dometscherin (FRZ/DE) – Kultusministerium Saarland, Saarbrücken.",
    li5: "Übersetzerprüfung – AKAD (Hochschule für Berufstätige), Fachgebiet Wirtschaft – Stuttgart.",
    li6: "Grosses Sprachdiplom des Goethe-Instituts - Frankfurt am Main.",
    li7: "Übersetzer – und Dolmetscher Prüfung der Industrie- und Handelskammer, Wiesbaden.",
    li8: "Prüfung für Handelsdeutsch, Deutch-französische Industrie- und Handelskammer, Paris.",
    li9: "Abschluss an der IFAG, Hochschule für Management",
  },
  course: "Berufserfahrung",
  exp1: "2010 bis heute: Lehrerin für Französisch und Wirtschaftsfranzösisch.",
  exp2: "1998 bis 2010: Übersetzerin und Dolmetscherin mit den Schwerpunkten Marketing, Kommunikation und Corporate Publishing.",
  exp3: "Crédit industriel et commercial- Beauftragte für die Beziehungen zur Muttergesellschaft in Paris, Frankfurt am Main, Deutschland.",
  exp4: "Bank of America - Officer / Administrative Services - Frankfurt am Main, Deutschland.",
  exp5: "Volkshochschule Main-Kinzig-Kreis - Französischlehrerin.",
  ...
  mailP: "Schicken Sie mir eine E-Mail",
  linkedin: "Linkedin",
  linkedinP: "Danielle Desteucq-Roettger",
  linkedinL: "Mein Linkedin-Profil",
  xing: "Xing",
  xingP: "Danielle Desteucq-Roettger",
  xingL: "Mein Xing-Profil",
};
